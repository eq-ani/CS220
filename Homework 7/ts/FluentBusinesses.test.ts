...
const categoryTestData: Business[] = [
...
const ambienceTestData: Business[] = [
...
const mostReviewsTestData: Business[] = [
...
describe("inCategory", () => {
  ...
  it("inCategory can be chained", () => {
    const list = new FluentBusinesses(
      categoryTestData.concat({
        business_id: "99",
